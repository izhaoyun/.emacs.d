 ...
 '(package-selected-packages
   (quote
    (sphinx-doc google-c-style yasnippet-snippets haskell-mode
                ...
                flycheck company-irony-c-headers org inf-ruby
                puppet-mode ivy-hydra ox-gfm rainbow-delimiters
                ob-http markdown-mode git-timemachine rtags
                elf-mode multiple-cursors smartparens yaml-mode
                ws-butler which-key web-mode use-package
                undo-tree python projectile popwin
                pip-requirements org-plus-contrib magit lispy
                js2-mode jinja2-mode hungry-delete htmlize
